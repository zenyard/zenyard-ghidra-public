 ...
 */
public class DecompaiApiClientFactory {
    
    /**
     * Create and configure an ApiClient from DecompaiOptions.
     * 
     * @param options The configuration options
     * @return Configured ApiClient instance
     */
    public static ApiClient createApiClient(DecompaiOptions options) {
        if (!options.isConfigured()) {
            throw new IllegalStateException("DecompAI options are not configured");
        }
