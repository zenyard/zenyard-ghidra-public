package com.zenyard.decompai.ghidra.api;
...
/**
 * Thin wrapper over HTTP client for DecompAI API.
 * Handles auth, base URL, and error normalization.
 * 
 * NOTE: mirrors functionality in decompai_client/api_client.py and decompai_client/decompai_api/*.py
 * This is a minimal implementation; candidate for future OpenAPI-based generation.
 */
public class DecompaiApiClient {
    ...
    public DecompaiApiClient(String baseUrl, String apiKey) {
     ...
     * @throws DecompaiApiException if the request fails
     */
    ...
    private <T> CompletableFuture<T> sendRequest(
        ...
        httpClient.sendAsync(request, HttpResponse.BodyHandlers.ofString())
                ...
                try {
                    ...
                    if (statusCode == 401) {
                        future.completeExceptionally(
                            new DecompaiUnauthorizedException("Unauthorized - check your API key"));
                        return;
                    } else if (statusCode == 403) {
                        future.completeExceptionally(
                            new DecompaiForbiddenException("Forbidden - insufficient permissions"));
                        return;
            ...
            .exceptionally(throwable -> {
                ...
                if (cause instanceof DecompaiApiException) {
