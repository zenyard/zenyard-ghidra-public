...
public class RevisionWorkflowManager {
    ...
    public RevisionWorkflowManager(PluginTool tool, BinariesApi binariesApi, DecompaiOptions options) {
        this.tool = tool;
    ...
    public UUID getOrRegisterBinary(Program program, TaskMonitor monitor) {
        ...
        ApiClient apiClient = DecompaiApiClientFactory.createApiClient(options);
    ...
    public int getCurrentRevision(DecompaiProgramProperties props) {
    ...
    public boolean validateFunction(com.zenyard.decompai.ghidra.api.generated.model.Function func) {
        try {
