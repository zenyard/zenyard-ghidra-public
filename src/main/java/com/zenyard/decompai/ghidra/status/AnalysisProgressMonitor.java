 ...
 * 
 * NOTE: mirrors functionality in decompai_ida/ui/status_bar_view_model.py
 */
public class AnalysisProgressMonitor implements EventConsumer {
    ...
    public Set<DecompaiEvent.EventType> getSubscribedEventTypes() {
        ...
        types.add(DecompaiEvent.EventType.ANALYSIS_STATUS_UPDATED);
        return types;
    }
    
    @Override
    public void handleEvent(DecompaiEvent event) {
        if (event.getType() == DecompaiEvent.EventType.ANALYSIS_STATUS_UPDATED) {
     ...
     * Mirrors _format_eta() in decompai_ida/ui/status_bar_view_model.py
     * 
