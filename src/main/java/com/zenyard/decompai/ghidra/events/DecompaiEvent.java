...
/**
 * Base event class for DecompAI task communication.
 * Events are immutable and carry type information, timestamp, source, and optional payload data.
 */
public class DecompaiEvent {
    
    /**
     * Event types used throughout the DecompAI plugin.
     */
    ...
    /**
     * Creates a new DecompaiEvent with the specified type and source.
     * 
     * @param type The event type
     * @param source The source task/component that published this event
     */
    public DecompaiEvent(EventType type, String source) {
        this(type, source, null);
    }
    
    /**
     * Creates a new DecompaiEvent with the specified type, source, and payload.
     * 
     * @param type The event type
     * @param source The source task/component that published this event
     * @param payload Optional payload data (can be null)
     */
    public DecompaiEvent(EventType type, String source, Map<String, Object> payload) {
        this.type = type;
        this.source = source;
