...
public class DownloadInferencesTask extends EventAwareTask {
    ...
    public Set<DecompaiEvent.EventType> getSubscribedEventTypes() {
        ...
        types.add(DecompaiEvent.EventType.SERVER_REVISION_UPDATED);
        return types;
    }
    
    @Override
    public void handleEvent(DecompaiEvent event) {
        if (event.getType() == DecompaiEvent.EventType.BINARY_ID_AVAILABLE) {
        ...
        } else if (event.getType() == DecompaiEvent.EventType.SERVER_REVISION_UPDATED) {
