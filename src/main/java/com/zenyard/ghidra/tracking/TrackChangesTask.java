...
public class TrackChangesTask implements EventProducer {
    ...
    private static final String PROPERTY_PREFIX = "Zenyard.";
    ...
    private void markObjectDirty(Address address) {
        ...
        boolean alreadyDirty = syncStatusStorage.getSyncStatus(address)
            .map(com.zenyard.ghidra.storage.SyncStatus::isDirty)
            .orElse(false);
        ...
        publishEvent(new ZenyardEvent(ZenyardEvent.EventType.CHANGES_DETECTED, "TrackChangesTask"));
    }
