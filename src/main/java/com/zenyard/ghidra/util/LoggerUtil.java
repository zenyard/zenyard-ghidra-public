 ...
 * 
 * NOTE: mirrors zenyard_ida/logger.py which opens per-IDB log files,
 * but uses Log4j2 to match Ghidra's logging infrastructure.
 */
public class LoggerUtil {
    
    private static final String LOG_DIR = "logs/zenyard";
    private static final String LOGGER_NAME = "com.zenyard.zenyard";
    ...
    public static void configureForProgram(String programName, String logLevel) {
        try {
            ...
            FileAppender fileAppender = FileAppender.newBuilder()
                .setName("Zenyard-" + sanitizeFileName(programName))
            ...
            logger.info("Zenyard logging initialized for program: {}", programName);
    ...
    /**
     * Get a Logger instance for the Zenyard package.
