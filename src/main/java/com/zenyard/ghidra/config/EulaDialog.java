...
/**
 * Modal dialog that presents Zenyard Terms of Use.
 */
public class EulaDialog extends ZenyardDialogComponentProvider {
    ...
    private static final String EULA_TEXT = String.join("\n",
        ...
        "4.1 Except for User Data that you provide, you acknowledge and agree that all the intellectual property rights, including copyrights, patents, trademarks, design rights related to the Services and trade secrets in the Services and their content are owned by the Company or our suppliers. All trademarks and all other marks, trade names, service marks, wordmarks, illustrations, images, audio/visual works, icons and scripts and other materials provided on or through the Services are the exclusive property of the Company or its suppliers and are subject to the protection granted by applicable laws or international treaties related to intellectual property. Neither these Terms of Use, nor your access to the Services, transfers to you or any third party any rights, title or interest in or to such intellectual property rights, except for the limited access rights expressly set forth herein. There are no implied licenses granted under these Terms of Use.",
    ...
    public EulaDialog() {
        super("Accept Zenyard Terms of Use", true);
        this.accepted = null;
        buildPanel();
    }
    ...
    private void buildPanel() {
        ...
        JPanel titlePanel = createTitlePanel("Accept Zenyard Terms of Use");
        ...
        gbc.weighty = 1.0;
        JTextArea textArea = new JTextArea(EULA_TEXT);
        ...
        if (baseSize != null && baseSize.width > 0 && baseSize.height > 0) {
            int targetWidth = (int) Math.round(baseSize.width * 1.5);
            int targetHeight = (int) Math.round(baseSize.height * 0.8);
    ...
    /**
     * Show the dialog and return whether the user accepted.
     */
    public static boolean showDialog(PluginTool tool) {
