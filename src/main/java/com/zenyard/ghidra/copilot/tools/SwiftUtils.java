 ...
 * Mirrors zenyard_ida/swift_utils.py
 */
public class SwiftUtils {
     ...
     * Mirrors is_swift_binary_sync() in zenyard_ida/swift_utils.py
     * 
     ...
     * Mirrors find_latest_swift_function_inference_sync() in zenyard_ida/swift_utils.py
     * 
