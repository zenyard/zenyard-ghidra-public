 ...
 * 
 * NOTE: mirrors zenyard_ida/show_initial_upload_message_task.py
 */
public class InitialUploadMessageDialog extends ZenyardDialogComponentProvider {
    ...
    protected void okCallback() {
        ...
        Msg.info(this, "Zenyard: Initial upload message acknowledged");
        close();
    }
     ...
     */
    public static void showDialogIfNeeded(PluginTool tool, ZenyardOptions options, Program program) {
     ...
     */
    private static void showDialogAndMarkShown(PluginTool tool, ZenyardOptions options,
                                               Program program, ZenyardProgramProperties props) {
